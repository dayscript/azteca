...
http://foundation.zurb.com/docs/faq.php or use the script in the azteca
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the azteca folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/azteca folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the azteca.info.yml.txt file to
    ...
    For example, rename the foo/azteca.info.yml.txt file to foo/foo.info.yml.
    Edit the foo.info.yml file and change "name: Foundation Sub-theme azteca"
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename azteca.libraries.yml to the name of your sub-theme, un-commenting
